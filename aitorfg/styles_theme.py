...
# Colores base (modo oscuro fijo por ahora para evitar problemas de versión).
# Cuando todo funcione, metemos el toggle real.
PAGE_BG = "linear-gradient(180deg, rgba(15,23,42,1) 0%, rgba(2,6,23,1) 100%)"
